...
def load_plm(model_name='sentence-transformers/sentence-t5-xxl', device='cuda'):
...
def parse_args():
    ...
    parser.add_argument('--plm_name', type=str, default='sentence-transformers/sentence-t5-xxl')
    parser.add_argument('--feat_name', type=str, default='t5-xxl', help='')
