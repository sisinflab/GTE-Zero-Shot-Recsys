...
def parse_args():
    ...
    parser.add_argument('--plm', type=str, default='HIT-TMG/KaLM-embedding-multilingual-mini-v1')
...
if __name__ == '__main__':
    ...
    for pr in tqdm(range(0, len(sorted_text), args.batch_size)):
        ...
        with torch.no_grad():
            tokenized = model.tokenizer(batch, padding=True, truncation=True, return_tensors="pt")
